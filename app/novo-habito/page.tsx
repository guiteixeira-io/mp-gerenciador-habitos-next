    ...
    return (
        <main className="container relative flex flex-col gap-8 px-12 pt-16">
            ...
            <form action={newHabit} className="flex flex-col gap-4 mt-4">
                ...
                <button
                    type="submit"
                    className="bg-[#49EDAD] font-display text-neutral-900 font-regular text-2xl p-2 rounded-md mt-8">
                    Cadastrar
                </button>
                <button
                    className="bg-neutral-800 text-[#F85858] rounded-md text-2xl p-2 font-regular font-display">
                    Cancelar
                </button>
            </form>
        </main>
